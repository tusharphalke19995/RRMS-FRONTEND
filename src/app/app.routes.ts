...
export const appRoutes: Route[] = [
        ...
        children: [
            ...
            {path: 'sign-up', loadChildren: () => import('app/modules/auth/sign-up/sign-up.routes')},
             {path: 'sign-out', loadChildren: () => import('app/modules/auth/sign-out/sign-out.routes')},
               {path: 'otp-verify', loadChildren: () => import('app/modules/auth/otp-verify/otp-verify.routes')},
        ]
    },
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'upload-approval', loadChildren: () => import('app/modules/admin/pages/case-data-approvals/case-data-approvals.routes')},
             {path: 'request-access', loadChildren: () => import('app/modules/admin/pages/request-access/request-access.routes')},
