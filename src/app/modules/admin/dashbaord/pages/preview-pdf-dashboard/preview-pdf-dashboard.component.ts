...
@Component({
  selector: 'app-preview-pdf-dashboard',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './preview-pdf-dashboard.component.html',
  styleUrl: './preview-pdf-dashboard.component.scss'
})
export class PreviewPdfDashboardComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  getUploadMetaDataFiles(res: any) {
    console.log("PreviewPdfDashboardComponent - Data received:", res);
    ...
    // Check if res is a base64-encoded object
