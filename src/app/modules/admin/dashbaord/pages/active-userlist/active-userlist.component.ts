...
import { AddUpdatDesignationRoleComponent } from "app/modules/admin/pages/Master/designations/add-update-msdesignation/add-update-msdesignation.component";
...
@Component({
  ...
  templateUrl: "./active-userlist.component.html",
  styleUrl: "./active-userlist.component.scss",
})
export class ActiveUserlistComponent implements OnInit, AfterViewInit {
