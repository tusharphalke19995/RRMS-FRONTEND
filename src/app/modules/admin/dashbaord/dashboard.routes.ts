...
import { PreviewPdfDashboardComponent } from './pages/preview-pdf-dashboard/preview-pdf-dashboard.component';
...
export default [
    ...
    {
        path:'preview-pdf-dashboard',
        component:PreviewPdfDashboardComponent
    }
] as Routes;
