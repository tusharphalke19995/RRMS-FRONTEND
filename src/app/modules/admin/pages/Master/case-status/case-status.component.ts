...
import { AddUpdateCaseStatusComponent } from './add-update-case-status/add-update-case-status.component';
...
export class CaseStatusComponent implements OnInit {
  ...
  updateCaseStatus(row: any): void {
    this.addCaseStatus(row);
  }
