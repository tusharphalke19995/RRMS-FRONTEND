...
export class UpdateFileMetadataComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<UpdateFileMetadataComponent>, @Inject(MAT_DIALOG_DATA) public data: any ,
  ...
  updateMetadata() {
    ...
    const payload = {
      ...
      id: this.fileToEdit?.id
    };

    // this.fileMetadataService.updateFileMetadata(payload).subscribe({
    //   next: (res) => {
